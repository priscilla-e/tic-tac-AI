...
I started this project to evaluate the performance of OpenAI's models in games. Over the course of the development process, I also did some research into Game Theory, focusing on the [**Minimax algorithm**](https://en.wikipedia.org/wiki/Minimax).
